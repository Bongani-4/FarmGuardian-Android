    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // create an Intent to start ViewACSetProfile activity
                Intent intent = new Intent(ACaretakerProfile2.this, ViewACSetProfile.class);

                // Pass data to the next activity
                intent.putExtra("fullNames", Fullnames);
                intent.putExtra("location", Location);
                intent.putExtra("contacts", Contacts);
                intent.putExtra("experience", Expirience);
                intent.putExtra("available", isavailable == 1); //  1 to true, 0 to false
