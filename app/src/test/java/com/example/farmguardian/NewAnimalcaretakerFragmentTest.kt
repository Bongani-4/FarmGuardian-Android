...
import com.example.farmguardian.views.NewAnimalcaretakerFragment
...
class NewAnimalcaretakerFragmentTest {
    ...
    private lateinit var fragment: NewAnimalcaretakerFragment

    @Before
    fun setUp() {
        MockitoAnnotations.openMocks(this)
        fragment = NewAnimalcaretakerFragment()
...
// Call onViewCreated with the mocked view
    ...
    fun testButtonClickWithData() {
        ...
        // Set up the fragment
        val fragment = NewAnimalcaretakerFragment()
            .apply {
