...
public final class ActivityEquipmentSharingBinding implements ViewBinding {
  ...
  @NonNull
  public static ActivityEquipmentSharingBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityEquipmentSharingBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_equipment_sharing, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
